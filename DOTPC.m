...
disp("============================================================================================")
disp("Design Optimization of Telecommunication Pole in Connecticut")
...
lemon  = @(z,v)[v(2);(-M(z)/(E*I(z)))];    %Solving ODE:  EIv"(z) = -M(x)  w/ I.C.s: v(0) = v'(0) = 0        
[t,v] = ode45(lemon,[0 H],[0; 0]);
